...
CREATE TABLE `book`  (
  ...
  `catalog` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '分类',
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES (1, 'aa', '123', 'Customer');
INSERT INTO `users` VALUES (2, 'admin', '123', 'Administrator');
INSERT INTO `users` VALUES (3, 'moderator', '123', 'Moderator');
INSERT INTO `users` VALUES (4, 'analyst', '123', 'Analyst');
